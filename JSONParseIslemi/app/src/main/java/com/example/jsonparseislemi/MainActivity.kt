...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val bayrakListe = jsonObject.getJSONArray("bayraklar")

            for (i in 0 until bayrakListe.length()) {
                val b = bayrakListe.getJSONObject(i)
        ...
        try {
            ...
            for (i in 0 until filmlerListe.length()) {
                ...
                Log.e("film yil", film_yil.toString())
                Log.e("film resim", film_resim)

                Log.e("kategori id", kategori_id.toString())
                Log.e("kategori ad", kategori_ad)

                Log.e("yonetmen id", yonetmen_id.toString())
                Log.e("yonetmen ad", yonetmen_ad)
